...
student@8b7ef5b32403:~/scripts$ ./generate_report.py 
student@8b7ef5b32403:~/scripts$ cd ~/data 
student@8b7ef5b32403:~/data$ ls
employees.csv  report.txt
student@8b7ef5b32403:~/data$ cat report.txt 
Development:4
Human Resources:2
IT infrastructure:4
Marketing:2
